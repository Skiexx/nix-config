...
# Настройки записываются напрямую в settings.json
# =============================================================================
{ inputs, lib, ... }:

{
  ...
  # Полный конфиг DMS — сохраняется при перезагрузке
  xdg.configFile."DankMaterialShell/settings.json" = {
    force = true;
    text = builtins.toJSON {
      currentThemeName = "custom";
      currentThemeCategory = "registry";
      customThemeFile = "/home/skiexx/.config/DankMaterialShell/themes/rosePine/theme.json";
